...
namespace ProyectoBDII
{
    public partial class Form10 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            conexionBD.Open();
            SqlCommand comando = new SqlCommand("select*from  [sfcontable].[dbo].[Asientos] order by ID", conexionBD);
            ...
            conexionBD.Close();
            string comandoconsulta = "SELECT SUM(Debito) as TotalDebito,SUM(Credito) as TotalCredito FROM [sfcontable].[dbo].[Asientos]";
            conexionBD.Open();
